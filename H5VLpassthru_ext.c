...
static herr_t H5VL_pass_through_ext_link_optional(void *obj, const H5VL_loc_params_t *loc_params, H5VL_link_optional_t opt_type, hid_t dxpl_id, void **req, va_list arguments);
...
static herr_t H5VL_pass_through_ext_object_optional(void *obj, const H5VL_loc_params_t *loc_params, H5VL_object_optional_t opt_type, hid_t dxpl_id, void **req, va_list arguments);
...
H5VL_pass_through_ext_str_to_info(const char *str, void **_info)
{
    ...
    printf("under_vol_value, under_vol_id: %u, %lld \n", under_vol_value, under_vol_id); 
...
H5VL_pass_through_ext_dataset_close(void *dset, hid_t dxpl_id, void **req)
{
    ...
    ret_value = H5VLdataset_close(m->under_object, m->under_vol_id, dxpl_id, req);
    ...
    hid_t fapl_id, hid_t dxpl_id, void **req)
{
    ...
    void *under2 = H5VLfile_create(tmp, flags, fcpl_id, under_fapl_id, dxpl_id, req);

    if(under && under2) {
        file = H5VL_pass_through_ext_new_obj(under, info->under_vol_id);
	file->map = H5VL_pass_through_ext_new_obj(under2, info->under_vol_id);
        /* Check for async request */
        if(req && *req)
...
H5VL_pass_through_ext_file_close(void *file, hid_t dxpl_id, void **req)
{
    ...
    ret_value = H5VLfile_close(m->under_object, m->under_vol_id, dxpl_id, req);
    /* Check for async request */
    if(req && *req)
        *req = H5VL_pass_through_ext_new_obj(*req, o->under_vol_id);
...
H5VL_pass_through_ext_group_close(void *grp, hid_t dxpl_id, void **req)
{
    ...
    ret_value = H5VLgroup_close(m->under_object, m->under_vol_id, dxpl_id, req);
    ...
    H5VL_object_optional_t opt_type, hid_t dxpl_id, void **req, va_list arguments)
{
    ...
    ret_value = H5VLobject_optional(o->under_object, loc_params, o->under_vol_id, opt_type, dxpl_id, req, arguments);
